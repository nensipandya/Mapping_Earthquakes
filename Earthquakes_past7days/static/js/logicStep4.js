...
d3.json(earthquake).then(function(data){
  ...
  L.geoJSON(data, {
    // We turn each feature into circleMarker on the map.
    pointToLayer: function(feature, latlng) {
        console.log(data);
        return L.circleMarker(latlng);
    },
    // We set the style for eacg circleMarker using our styleInfo function.
    style: styleInfo,
